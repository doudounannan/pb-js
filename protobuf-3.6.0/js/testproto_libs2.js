...
goog.provide('proto.jspb.exttest.floatingMsgFieldTwo');
...
goog.provide('proto.jspb.test.framing.FramingMessage');
...
goog.require('proto.jspb.exttest.ExtensionMessage');
goog.require('proto.jspb.exttest.TestExtensionsMessage');
goog.require('proto.jspb.test.Deeply.Nested.Message');
goog.require('proto.jspb.test.ForeignMessage');
goog.require('proto.jspb.test.importing.ImportedMessage');
...
proto.jspb.test.framing.FramingMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    importedMessage: (f = msg.getImportedMessage()) && proto.jspb.test.importing.ImportedMessage.toObject(includeInstance, f)
  };
...
proto.jspb.test.framing.FramingMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.jspb.test.importing.ImportedMessage;
      reader.readMessage(value,proto.jspb.test.importing.ImportedMessage.deserializeBinaryFromReader);
...
proto.jspb.test.framing.FramingMessage.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.jspb.test.importing.ImportedMessage.serializeBinaryToWriter
    );
  }
};
...
proto.jspb.test.framing.FramingMessage.prototype.getImportedMessage = function() {
  return /** @type{?proto.jspb.test.importing.ImportedMessage} */ (
    jspb.Message.getWrapperField(this, proto.jspb.test.importing.ImportedMessage, 1));
};
...
proto.jspb.exttest.TestExtensionsMessage.extensionsBinary[103] = new jspb.ExtensionFieldBinaryInfo(
...
// This registers the extension field with the extended class, so that
// toObject() will function correctly.
proto.jspb.exttest.TestExtensionsMessage.extensions[103] = proto.jspb.exttest.floatingMsgFieldTwo;
